...
const App: React.FC = () => {
  ...
  // Theme State with Time-based Default
  const [isDarkMode, setIsDarkMode] = useState(() => {
    if (typeof window !== 'undefined') {
        ...
        // Default: Light mode 5 AM (5) to 5 PM (17), Dark mode otherwise
    ...
    <div className="flex h-screen bg-stone-50 dark:bg-stone-900 w-full overflow-hidden font-sans text-stone-900 dark:text-stone-100">
      ...
      {!isChatOpen && user && (
          <button
            ...
            className="fixed bottom-20 right-4 md:bottom-8 md:right-8 z-50 p-4 bg-green-600 text-white rounded-full shadow-lg shadow-green-200 dark:shadow-none hover:bg-green-700 hover:scale-105 active:scale-95 transition-all animate-in zoom-in duration-300"
          >
